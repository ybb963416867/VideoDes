...
public class CustomFileCipherUtil {
     ...
     * @return
     */
    public  static boolean aesEncrypt(String strFile, CipherListener listener) {
     ...
     * @return
     */
    public static boolean desCrypt(String strFile, CipherListener listener) {
        int len = REVERSE_LENGTH;
        long startTime = System.currentTimeMillis();
        try {
            File f = new File(strFile);
